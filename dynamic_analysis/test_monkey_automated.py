...
print(f"{bcolors[6]}" + 'Finished Setting up; Listen 5 minutes without interaction')
...
print(f"{bcolors[6]}" + 'Starting monkey for 10 minutes')
monkey_command = "time adb shell monkey --throttle 1 -s " + seed + " -p " + package_name + " -v 600000 > ./monkey_output/" + package_name
(t0, p0) = start_thread(monkey_command, "frida_laptop", 0)
