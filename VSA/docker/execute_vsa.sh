...
#timeout --foreground --kill-after=50m 40m java -Xms5g -Xmx8g -jar /vsa/vsa.jar -d  /vsa/config/endpoints.json  -p /vsa/dependencies/android-31.jar -o /results/endpoints/ -t /vsa/config/taintrules.json -a $1 -dj /vsa/dependencies/dex_tools_2.1/d2j-dex2jar.sh --dont_overwrite  -mb 150 -mbc 50 -tb 5 -tf 2;